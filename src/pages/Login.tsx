  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Bienvenido de nuevo a KÜID",
      });
    } catch (error) {
      toast({
  ...
  return (
    <div className="auth-body min-h-screen flex items-center justify-center bg-very-light-alt p-4">
      <div className="auth-container w-full max-w-md bg-white rounded-lg shadow-kuid p-8">
        ...
        <h2 className="text-2xl font-semibold mb-8 text-dark text-center">Iniciar Sesión</h2>
        ...
        <div className="flex items-center text-center text-secondary my-6">
          ...
          <span className="px-4 text-sm">o continuar con email</span>
          <div className="flex-1 border-t border-gray-200"></div>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex justify-between items-center mb-6 text-sm">
            <div className="flex items-center gap-2">
              ...
              <label htmlFor="remember" className="text-secondary cursor-pointer">Recuérdame</label>
            </div>
